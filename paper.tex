...
\definecolor{ours}{RGB}{0,71,171} % cobolt blue
...
\begin{figure}[htbp]
  ...
  \caption{Hovering over a name stack reveals the authors in their original
    ...
    Visual Studio Code LaTeX Workshop Extension's internal PDF viewer,
    which is based on PDF.js.}
